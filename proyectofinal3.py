...
#cbtis 89
#programacion 3°b
#Proyecto Final: Sistema de Punto de Venta para Ropa
...
def abrir_registro_ventas():
    ...
    ven.cantidad_var = cantidad_var   # mantiene la referencia
